...
#line 91 "compiler.tab.c" /* yacc.c:339  */
...
{
       0,    40,    40,    41,    42,    43,    44,    45,    47,    48,
      50,    51,    53,    54,    57,    58,    61,    70,    71,    74,
      75,    78,    79,    82,    83,    86,    87,    89,    92,    93,
      95,    98,    99,   103,   104,   105,   109,   110,   112,   114,
     116
};
#endif
...
static const char *const yytname[] =
{
  ...
  "c_while", "boolValue", "intVal", "ADD", "SUB", "MUL", "DIV", "ABS",
  "NEG", "EOL", "SPACE", "AND", "OR", "XOR", "POW", "'('", "')'", "'{'",
  "'}'", "'='", "';'", "$accept", "S", "booleval", "bool_and", "bool_not",
  "bool_rel", "eval", "bitor", "bitxor", "bitand", "bitneg", "exp",
  "factor", "powterm", "term", "initialisation", "declarations",
  "datatype", "identifier", YY_NULLPTR
};
#endif
...
static const yytype_uint16 yytoknum[] =
{
     ...
     275,   276,   277,    40,    41,   123,   125,    61,    59
};
# endif
...
{
       6,    -5,    19,     1,   -10,   -10,    18,   -10,   -10,    23,
       1,    13,    21,   -10,   -10,    32,    49,    40,    45,    47,
     -10,    -9,    30,   -10,   -10,   -10,    43,    48,   -10,    44,
     -10,   -10,    62,    46,    41,    42,    44,     4,    51,    54,
     -10,     9,    39,   -10,    52,     1,     1,   -10,   -10,    50,
       6,   -10,   -10,     9,    35,   -10,    35,    44,    44,    44,
      44,    44,    44,    21,   -10,   -10,     0,    51,    54,   -10,
      39,    39,   -10,   -10,   -10,    58,   -10
};
...
{
       2,     0,     0,     0,     1,    39,    34,    33,    14,     0,
       0,     0,     8,    10,    12,     0,     0,     0,     0,     0,
      34,     0,     0,    35,    13,     7,     0,     0,     5,     0,
       4,     3,     0,     0,    33,     0,     0,     0,    17,    19,
      21,    23,    25,    28,    31,     0,     0,    15,    40,     0,
       2,    36,    37,    24,     0,    16,     0,     0,     0,     0,
       0,     0,     0,     9,    11,    38,     0,    18,    20,    22,
      26,    27,    29,    30,    32,     0,     6
};
...
{
     -10,    26,    65,    34,    -8,   -10,   -10,   -10,    27,    24,
     -10,    53,     2,    15,    -2,   -10,   -10,   -10,   -10
};

  /* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     2,    11,    12,    13,    14,    15,    37,    38,    39,
      40,    41,    42,    43,    44,    17,    18,    19,    49
};
...
{
      16,    16,    24,     5,     6,    20,     7,     7,    16,     8,
       8,    26,     9,     9,     1,    33,    10,    10,     3,     4,
      58,    59,     5,     6,    54,     7,    75,    47,     8,    23,
      25,     9,    55,    26,    20,    10,    34,    35,    64,    20,
      27,     7,     9,    16,    16,    22,    36,     9,    20,    28,
       7,    36,    60,    61,    29,    69,     9,    30,    72,    73,
      70,    71,    31,    45,    16,    32,    48,    46,    21,    51,
      52,    50,    56,    57,    62,    76,    66,    74,    65,    63,
      68,    67,     0,     0,     0,     0,     0,     0,     0,    53
};

static const yytype_int8 yycheck[] =
{
       2,     3,    10,     3,     4,     4,     6,     6,    10,     9,
       9,    20,    12,    12,     8,    24,    16,    16,    23,     0,
      11,    12,     3,     4,    20,     6,    26,    29,     9,     6,
      17,    12,    28,    20,     4,    16,     6,     7,    46,     4,
      19,     6,    12,    45,    46,    27,    16,    12,     4,    17,
       6,    16,    13,    14,     5,    57,    12,    17,    60,    61,
      58,    59,    17,    20,    66,    18,     4,    19,     3,    28,
      28,    25,    21,    19,    22,    17,    50,    62,    28,    45,
      56,    54,    -1,    -1,    -1,    -1,    -1,    -1,    -1,    36
};
...
{
       0,     8,    30,    23,     0,     3,     4,     6,     9,    12,
      16,    31,    32,    33,    34,    35,    43,    44,    45,    46,
       4,    31,    27,     6,    33,    17,    20,    19,    17,     5,
      17,    17,    18,    24,     6,     7,    16,    36,    37,    38,
      39,    40,    41,    42,    43,    20,    19,    43,     4,    47,
      25,    28,    28,    40,    20,    28,    21,    19,    11,    12,
      13,    14,    22,    32,    33,    28,    30,    37,    38,    43,
      41,    41,    43,    43,    42,    26,    17
};
...
#line 43 "compiler.y" /* yacc.c:1646  */
    {printTable(); tcount =0; tvalues.clear();}
...
#line 48 "compiler.y" /* yacc.c:1646  */
    { strcpy((yyval.str),((threeAddress((yyvsp[-3].str), (yyvsp[0].str), "||")).c_str())); }
...
#line 1344 "compiler.tab.c" /* yacc.c:1646  */
    break;
...
#line 105 "compiler.y" /* yacc.c:1646  */
    {string s1((yyvsp[0].str)), s2 ="-"; s2=s2+s1; tvalues[tcount]=s2; strcpy((yyval.str),(s2.c_str())); cout<<"t"<<tcount++<<" = "<<s2<<endl; }
#line 1451 "compiler.tab.c" /* yacc.c:1646  */
    break;

  case 36:
#line 109 "compiler.y" /* yacc.c:1646  */
    { intialiseValue((yyvsp[-3].str), (yyvsp[-1].str));}
...
#line 112 "compiler.y" /* yacc.c:1646  */
    {  struct variable temp; string st((yyvsp[-3].str));temp.type=st; string st1((yyvsp[-1].str));temp.name=st1; temp.value = ""; table.push_back(temp); }
...
#line 118 "compiler.y" /* yacc.c:1906  */
